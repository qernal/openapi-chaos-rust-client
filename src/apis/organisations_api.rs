...
pub async fn get_organisations(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::GetOrganisations200ResponseInner>, Error<GetOrganisationsError>> {
    let local_var_configuration = configuration;
