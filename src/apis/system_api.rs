...
/// Get health of Chaos
pub async fn get_system_health(configuration: &configuration::Configuration, ) -> Result<crate::models::GetSystemHealth200Response, Error<GetSystemHealthError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/system/health", local_var_configuration.base_path);
