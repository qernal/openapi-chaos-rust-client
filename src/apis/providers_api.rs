...
pub async fn get_providers(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::GetProvidersSuccessResponseSchemaInner>, Error<GetProvidersError>> {
